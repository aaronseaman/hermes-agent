...
- reject options -> Oria `deny`

Timeouts and bridge failures deny by default.

### Tool rendering helpers

`acp_adapter/tools.py` maps Oria tools to ACP tool kinds and builds editor-facing content.
...
- `hermes_cli/main.py` — `oria acp` CLI subcommand
