...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Oria — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Oria tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Oria core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build an Oria Plugin](/developer-guide/plugins)
...
- [ ] Tested with `oria chat -q "Use the weather tool for London"`
