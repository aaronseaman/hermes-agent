...
4. Fill in:
   - **Name:** `Oria Teams Meeting Pipeline` (or any name you'll recognize).
...
Oria ships a Graph auth smoke-test. From your Oria install:
...
3. Restart the gateway so the new secret is picked up: `oria gateway restart`.
