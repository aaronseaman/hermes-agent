...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Oria terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Oria itself, `model.provider: openai-codex` uses Hermes-managed Codex
...
When invoking the Codex CLI from an Oria gateway/service context (for example,
