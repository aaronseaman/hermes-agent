...
| | |
|---|---|
| Source | Optional — install with `oria skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Oria"), set an optional expiry, and click **Generate Token**
