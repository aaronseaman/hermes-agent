...
| | |
|---|---|
| Source | Optional — install with `oria skills install official/web-development/page-agent` |
...
- User wants **Oria itself to drive a browser** → use Oria's built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
