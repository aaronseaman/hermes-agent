...
| | |
|---|---|
| Source | Optional — install with `oria skills install official/health/neuroskill-bci` |
...
Connect Oria to a running [NeuroSkill](https://neuroskill.com/) instance to read
