...
| | |
|---|---|
| Source | Optional — install with `oria skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research\darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Oria |
| License | MIT |
...
import upstream classes into Oria itself.
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Oria core.
