...
| | |
|---|---|
| Source | Optional — install with `oria skills install official/research/blogwatcher` |
...
## Working with Oria tools (read this first)

`blogwatcher-cli` is the feed database; Oria tools do the automation around it:
