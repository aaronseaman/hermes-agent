...
| | |
|---|---|
| Source | Optional — install with `oria skills install official/research/qmd` |
...
Oria via the native MCP client. This is the preferred
...
Then configure Oria to connect via HTTP:
