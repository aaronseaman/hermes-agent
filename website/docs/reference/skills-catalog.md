...
| [`hermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) | Use, configure, theme, extend, and orchestrate Oria. | `autonomous-ai-agents\hermes-agent` |
...
| [`inspecting-hermes-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-hermes-desktop-dom) | Read the live Oria desktop DOM/CSS over CDP. | `software-development\inspecting-hermes-desktop-dom` |
