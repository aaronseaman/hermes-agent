...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Oria' : 'Setting up Oria'

  const description = isUpdate
    ? 'Oria is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Oria installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
