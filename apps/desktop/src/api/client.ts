...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Oria gateway connection closed',
      connectErrorMessage: 'Could not connect to Oria gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Oria gateway is not connected',
