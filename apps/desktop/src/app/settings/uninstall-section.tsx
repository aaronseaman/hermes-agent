...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Oria agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the Oria agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the Oria agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Oria agent, and all of your config, chats, secrets, and logs',
