...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Oria session"),
        ...
        _cmd("status", "Show Oria session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Oria agent"),
        ...
        _cmd("update", "Update Oria to the latest version"),
        _cmd("restart", "Gracefully restart the Oria gateway"),
        ...
        _cmd("thread", "Create a new thread and start an Oria session in it",
