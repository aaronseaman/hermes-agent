...
def _legacy_group_fence_error(rid, session, params):
    ...
    if hosted or peer:
        ...
        return _err(
            rid, 4122, f"This room is managed by {owner}. Update Oria Desktop to continue it.")
    return None
...
def _parse_truncation_params(rid, sid, session, params, history):
    ...
    return None, None, _err(
        ...
        "(update your Oria client if a rewind was intended)")
...
_PREVIEW_RESTART_RULES = (
    "Restart exactly the app intended for the Preview URL, not Oria Desktop itself.",
    ...
    "Before declaring success, verify the Preview URL responds with the intended app, not Oria Desktop. If it serves Hermes/Desktop UI or another unrelated app, stop that process and report failure.",
