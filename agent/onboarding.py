...
def openclaw_residue_hint_cli() -> str:
    ...
    return (
        ...
        "To port your config, memory, and skills over to Oria, run `oria claw migrate`.\n"
        "If you've already migrated and want to archive the old directory, run `oria claw cleanup` "
