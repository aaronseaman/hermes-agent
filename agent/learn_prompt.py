...
Follow the Oria skill-authoring standards exactly. These are the same
...
- version: 0.1.0
- author: always the literal value `Oria`. NEVER fill it from the host
  ...
  a privacy leak the user never opted into; the skill names itself as Oria.
...
4. "## How to Run" — the canonical invocation, framed through Oria tools.
...
- Reference Oria tools by name in backticks: `terminal`, `read_file`,
