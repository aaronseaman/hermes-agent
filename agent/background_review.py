...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Oria, e.g. 'hermes-agent').\n"
    "  • Hub-installed skills (installed via 'oria skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'oria curator pin'). You are an autonomous no-user-present "
    ...
    "recommend 'oria curator adopt <name>' — do not try to patch it.\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "  • Hub-installed skills (installed via 'oria skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'oria curator pin'). Pin blocks autonomous writes entirely — "
    ...
    "recommend 'oria curator adopt <name>' instead.\n"
    "If the only skills that need updating are protected, say\n"
    "'Nothing to save.' and stop.\n\n"
