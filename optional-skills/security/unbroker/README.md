...
The design is **Oria-native**: a small deterministic Python CLI (`scripts/pdd.py`) owns the state
...
Then start a new Oria session and drive it (below). The skill works zero-config; a few optional
...
- **PII handling.** Dossiers live under the Oria home directory (`0600`, optionally
