...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     "hermes_env_access", "critical", "exfiltration", "directly references Oria secrets file"),
    ...
    (_prose_modify_re(_HERMES_CONFIG_FILES),
     "hermes_config_mod", "high", "persistence", "modification language aimed at Oria configuration files (verify intent)"),
    (_shell_write_re(_HERMES_CONFIG_FILES),
     "hermes_config_mod_shell", "critical", "persistence", "shell write (redirect/sed -i/tee/cp/mv) targeting Oria configuration files"),
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     "hermes_config_ref", "low", "persistence", "references Oria configuration files (informational; only modification intent is scored)"),
