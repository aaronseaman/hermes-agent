...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Oria with an interactive wizard. "
        "Run a specific section: "
        "oria setup model|tts|terminal|gateway|tools|telemetry|agent")
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'oria setup' now does this.")
    setup_parser.add_argument(
