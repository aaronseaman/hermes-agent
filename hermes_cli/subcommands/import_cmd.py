...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import", help="Restore an Oria backup from a zip file",
        description="Extract a previously created Oria backup into your "
        "Oria home directory, restoring configuration, skills, "
        "sessions, and data")
