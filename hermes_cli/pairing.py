...
def pairing_command(args):
    ...
    if handler is None:
        print("Usage: oria pairing {list|approve|revoke|clear-pending}")
        print("Run 'oria pairing --help' for details.")
    else:
        handler()
...
def _cmd_list(store):
    ...
    if pending:
        ...
        print("\n  Approve with: oria pairing approve <platform> <request-id>")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'oria pairing list' to see pending requests.\n")
