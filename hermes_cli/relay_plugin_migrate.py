...
def migrate_profile_relay_env(home: Path, *, validate: bool = True) -> RelayMigrationResult:
    ...
    header = (
        "# NeMo Relay plugin configuration for Oria (selected via "
        f"{RELAY_PLUGINS_CONFIG_ENV} in .env).\n"
        "# Generated by `oria update` from the legacy HERMES_NEMO_RELAY_ATIF_*/ATOF_* variables,\n"
...
RELAY_MIGRATE_COMMAND = "oria migrate relay"
