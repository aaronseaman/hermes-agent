...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("snapshot", "Create or restore state snapshots of Oria config/state", "Session",
    ...
    CommandDef("goal", "Set a standing goal Oria works on across turns until achieved", "Session",
    ...
    CommandDef("update", "Update Oria to the latest version", "Info",
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("version", "Show Oria version", "Info", aliases=("v",),
