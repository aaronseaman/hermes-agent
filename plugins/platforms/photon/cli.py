...
def register_cli(parser: argparse.ArgumentParser) -> None:
    ...
    p_setup.add_argument("--project-name", default=None, help="Project name (default: 'Oria')")
...
def _cmd_setup(args: argparse.Namespace) -> int:
    ...
    print("\n✓ Photon setup complete.\n  Start the gateway:  oria gateway start")
    return 0
...
def _cmd_telemetry(args: argparse.Namespace) -> int:
    ...
    print("  Restart the gateway for the sidecar to pick it up:  oria gateway restart")
    return 0
