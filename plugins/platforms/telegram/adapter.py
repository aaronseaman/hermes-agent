...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "or another process is using the same bot token. To recover: ensure no other Oria or OpenClaw instance is running "
            "with this token, then restart the gateway with 'oria gateway restart'."
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="Run `oria setup` to install Telegram support.", setup_fn=interactive_setup, apply_yaml_config_fn=_apply_yaml_config,
